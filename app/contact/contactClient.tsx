      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ContactPage",
            name: "Contact Sol Medspa",
            description: "Get in touch with Sol Medspa for mobile aesthetic treatments",
            url: "https://sol-medspa.com/contact",
            mainEntity: {
              ...
              <Card className="bg-white border-stone-200 shadow-lg p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-stone-800 mb-1">Service Area</h3>
                      <p className="text-stone-600">Serving Los Angeles, Riverside County & Surrounding Areas</p>
                      <p className="text-stone-500 text-sm mt-1 italic">Mobile service - We come to you!</p>
                    </div>
                  </div>
                </div>
              </Card>
